package com.power4j.oauth2.security.realm.jdbc;
...
import com.power4j.oauth2.security.OAuth2AuthenticationException;
...
/**
 * ClassName: com.power4j.oauth2.security.OAuth2JdbcRealm <br>
 *
 * @author Kuo Hong
 * @version 2015-10-14
 */
public class OAuth2JdbcRealm extends Power4JRealm {
    ...
    private void validateToken(String token, ServerAccessToken accessToken) throws
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken token) throws AuthenticationException {
        ...
        ServerAccessToken aToken = rsService.loadAccessTokenByTokenId(accessToken);
        ...
        String username = aToken.getOpenid();
