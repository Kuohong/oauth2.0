...
import com.power4j.oauth2.security.OAuthPrincipal;
...
public class Power4JOAuthRSProvider implements OAuthRSProvider {
    ...
    public OAuthDecision validateRequest(String rsId, String token, HttpServletRequest req) throws
        ...
        //TODO: It is OK?
        Power4JOAuthDecision oAuthDecision = new Power4JOAuthDecision().setOAuthClient(new com.power4j.oauth2.security.rsfilter.pojo.RSOAuthClient(clientDetails));
        oAuthDecision.setPrincipal(new OAuthPrincipal(accessToken.getOpenid()));
