 ...
 */
package org.power4j.oauth2.validator;
...
public class ClientCredentialsClientDetailsValidator extends AbstractOauthTokenValidator {
    ...
    /**
    * /oauth2.0/token?client_id=credentials-client&client_secret=credentials-secret&grant_type=client_credentials&scope=read write
    * */
    @Override
