...
import org.power4j.oauth2.security.OAuth2Token;
import org.power4j.oauth2.security.Power4JRealm;
...
/**
 * ClassName: com.power4j.oauth2.security <br>
...
public class OAuth2JdbcRealm extends Power4JRealm {
    ...
    private void validateToken(String token, ServerAccessToken accessToken) throws OAuth2AuthenticationException {
        if (accessToken == null) {
