...
import com.power4j.oauth2.rs.dao.ClientDetailsDao;
import com.power4j.oauth2.rs.dao.ServerAccessTokenDao;
...
public class OAuthRSServiceImpl implements OAuthRSService {
    ...
    public ServerAccessToken loadAccessTokenByTokenId(String tokenId) {
       return serverAccessTokenDao.findAccessTokenByTokenId(tokenId);
    }
    ...
    public ClientDetails loadClientDetails(String clientId, String resourceIds) {
        ...
        return clientDetailsDao.findClientDetailsByClientIdAndResourceIds(clientId, resourceIds);
    }
